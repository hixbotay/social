                ...
                <form enctype='multipart/form-data' method="POST" action="{{url('admin?controller=DatingPrice&task=store')}}">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="data[double_dating_price]">
                        </div>


                        <div class="form-group">
                            <label>Giá hẹn nhóm (Nam)<span></span></label>
                            <input type="number" step="0.01" class="form-control" name="data[group_dating_m_price]">
                        </div>


                        <div class="form-group">
                            <label>Giá hẹn nhóm (Nữ)<span></span></label>
                            <input type="number" step="0.01" class="form-control" name="data[group_dating_f_price]">
                        </div>
