<div class="scrollbar-wrapper">
    <div>
        ...
        <ul class="metisMenu nav" id="side-menu">
            ...
            <li>
                <a href="javascript: void(0);" aria-expanded="true"><i
                            class="mdi mdi-settings"></i> @lang('admin.OTHER_CONFIG') <span class="fa arrow"></span></a>
                <ul class="nav-second-level nav" aria-expanded="true">

                    <li><a href="{{url('/admin?view=Job')}}"><i class="ti-person"></i>@lang('admin.JOB')</a></li>

                    <li><a href="{{url('/admin?view=ProvinceGroup')}}"><i
                                    class="ti-person"></i>@lang('admin.PROVINCE_GROUP')</a></li>
